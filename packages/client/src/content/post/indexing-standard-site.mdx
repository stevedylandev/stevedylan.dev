...
tags: ["atproto"]
ogImage: "/blog-images/indexing-standard-site.png"
hidden: false
...
![A white outline icon of a floppy disk on a dark gray background. The floppy disk has a rectangular shape with a cut corner at the top left, a small rectangular label area at the top, and a circular element in the center with a crosshair or targeting symbol inside it.](/blog-images/indexing-standard-site.png)
